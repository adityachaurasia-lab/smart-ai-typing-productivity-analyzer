...
const TypingProductivityAnalyzer = () => {
  ...
  const generateAIParagraph = async () => {
    ...
    const fallbackParagraphs = {
      ...
      expert:
        "The epistemological implications of machine learning algorithms—particularly their capacity for pattern recognition beyond human cognitive thresholds—necessitate fundamental reassessment of our ontological frameworks; moreover, the recursive self-improvement potential (colloquially termed 'intelligence explosion') presents unprecedented existential considerations that transcend traditional risk-assessment methodologies.",
    };
